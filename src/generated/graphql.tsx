...
export type LaunchesQuery = { __typename?: 'Query' } & {
	launches?: Maybe<
		Array<
			Maybe<
				{ __typename?: 'Launch' } & Pick<
					Launch,
					'flight_number' | 'mission_name' | 'launch_year' | 'launch_success'
				>
			>
		>
	>;
...
export type LaunchinfoQuery = { __typename?: 'Query' } & {
	launch?: Maybe<
		{ __typename?: 'Launch' } & Pick<
			Launch,
			| 'flight_number'
 ...
 * });
 */
export function useLaunchinfoQuery(
	baseOptions?: Apollo.QueryHookOptions<
		LaunchinfoQuery,
		LaunchinfoQueryVariables
	>
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<LaunchinfoQuery, LaunchinfoQueryVariables>(
		LaunchinfoDocument,
		options
	);
}
export function useLaunchinfoLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		LaunchinfoQuery,
		LaunchinfoQueryVariables
	>
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<LaunchinfoQuery, LaunchinfoQueryVariables>(
		LaunchinfoDocument,
		options
	);
}
export type LaunchinfoQueryHookResult = ReturnType<typeof useLaunchinfoQuery>;
export type LaunchinfoLazyQueryHookResult = ReturnType<
	typeof useLaunchinfoLazyQuery
>;
export type LaunchinfoQueryResult = Apollo.QueryResult<
	LaunchinfoQuery,
	LaunchinfoQueryVariables
>;
